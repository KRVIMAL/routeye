...
export const CustomTabsExamples = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-12">
      <h1 className="text-3xl font-bold text-gray-800 mb-8">Custom Tabs Examples</h1>

      {/* Horizontal Tabs */}
      <div className="space-y-4">
        <h2 className="text-xl font-semibold text-gray-700">Horizontal Status Tabs</h2>
      ...
      {/* Vertical Tabs */}
      <div className="space-y-4">
        <h2 className="text-xl font-semibold text-gray-700">Vertical Status Tabs</h2>
        <div className="p-6 bg-gray-50 rounded-lg">
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          <h3 className="text-lg font-medium text-gray-600">Medium Size (Default)</h3>
          <div className="p-4 bg-gray-50 rounded-lg">
            <CustomTabs
              tabConfig={consultantTabs}
              selected={compactTab}
      ...
      {/* Tabs without Counts */}
      <div className="space-y-4">
        <h2 className="text-xl font-semibold text-gray-700">Tabs without Counts</h2>
        <div className="p-6 bg-gray-50 rounded-lg">
          <CustomTabs
            tabConfig={consultantTabs}
            selected={compactTab}
      ...
      <div className="space-y-4">
        <h2 className="text-xl font-semibold text-gray-700">Tabs with Disabled State</h2>
        <div className="p-6 bg-gray-50 rounded-lg">
          <CustomTabs
            tabConfig={[
      ...
      <div className="space-y-4">
        <h2 className="text-xl font-semibold text-gray-700">Real-world Usage (Consultant Management)</h2>
